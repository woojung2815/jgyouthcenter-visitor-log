            ...
            function applyStyles() {{
                ...
                buttons.forEach(btn => {{
                    ...
                    if (t === "뒤로 가기") {{
                        ...
                        // 색상/테두리 강제 없음(기본 Streamlit 테마 적용)
                    }}
                }});
            }}
...
if st.session_state.is_admin and st.session_state.page == "admin":
    ...
    if df.empty:
        ...
        # ============================================================
        # ✅ 1) 데이터 편집/삭제 (상세 필터링과 무관하게 전체 데이터)
        # ============================================================
            ...
            if f_df2.empty:
                ...
                if chart_df.empty:
                    ...
                    fig_daily.update_xaxes(
                        tickformat="%-m/%-d",  # 2/3 형태 (환경에 따라 02/03)
                        title_text="날짜",
                    )
